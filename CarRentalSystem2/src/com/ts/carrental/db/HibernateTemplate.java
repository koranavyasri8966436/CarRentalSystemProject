...
public class HibernateTemplate {
	...
	public static List getCurrentBookedCars(int cId, String paymentStatus) {
		String queryString = "from Rent  rent where rent.customer.cId = :cId and rent.paymentStatus = :paymentStatus";
		Query query = sessionFactory.openSession().createQuery(queryString);
		query.setString("paymentStatus", paymentStatus);
		query.setParameter("cId", cId);
		List<Car> queryResult = query.list();
		return queryResult;
	}

	public static List getPreviousBookedCars(int cId, String paymentStatus) {
		String queryString = "from Rent  rent where rent.customer.cId = :cId and rent.paymentStatus != :paymentStatus";
		Query query = sessionFactory.openSession().createQuery(queryString);
		query.setString("paymentStatus", paymentStatus);
		query.setParameter("cId", cId);
	...
	public static List getCarListByQuery(int capacity) {
		String queryString = "from Car where capacity = :capacity";
		Query query = sessionFactory.openSession().createQuery(queryString);
