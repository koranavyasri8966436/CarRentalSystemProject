...
<body>
	<div id="main">
		<div>
			<a href="AdminHome.html" class="btn btn-danger"> <span
				class="glyphicon glyphicon-arrow-left"></span> Back
			</a> <img src="images/logo-home.png">
		</div>
			...
			<table class="table table-hover ">
				...
				<c:forEach var="car" items="${carsData}">
					<tr>
						...
						<td><a href="displayCar.jsp?image=${car.image}"> <img
								src="images/${car.image}" height="90" width="150"></a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
