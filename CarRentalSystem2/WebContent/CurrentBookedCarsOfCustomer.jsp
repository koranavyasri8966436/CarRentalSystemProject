    ...
    <thead>
        <tr>
            ...
            <tr> 
				...
				<td>
                <a href="ReturnCar?receiptNo=${rent.receiptNo}" class='btn btn-info'><span class="glyphicon glyphicon-backward"></span> ReturnCar</a> 
                </br>
                <a href="ExtendRent?receiptNo=${rent.receiptNo}" class='btn btn-success '><span class="glyphicon glyphicon-plus"></span> ExtendDate</a>
                </br>
                <a href="CancelRent?receiptNo=${rent.receiptNo}" class='btn btn-danger'><span class="glyphicon glyphicon-remove"></span> CancelBooking</a> 
				<td>
            </tr>
        </c:forEach>
    </table>
