...
body {
  margin: 0;
  padding: 0;
  background-image:url("https://www.geeky-gadgets.com/wp-content/uploads/2014/11/ShelbyGT350_01_HR.jpg");
...
<div class="form-group">
  <label class="col-md-7 control-label" for="Id"><font size="3">Customer Id</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-7 control-label" for="name"><font size="3">Name</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="email"><font size="3">Email ID</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="UserName"><font size="3">User Name</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="password"><font size="3">Password</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-7 control-label" for="cAddress"><font size="3">Address</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="MobileNumber"><font size="3">MobileNumber</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-7 control-label" for="cLicenseNo"><font size="3">LicenseNumber</font></label>  
  <div class="col-md-4">
...
<!-- Button -->
<div class="form-group">
  <label class="col-md-9 control-label" fhttp://www.arcticlighthotel.fi/files/5614/7737/8810/ArcticLightHotel_car_rental.jpgor="submit"></label>
