...
<div class="form-group">
  <label class="col-md-7 control-label" for="carModel"><font size="3">Car Model</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="carColor"><font size="3">Car Color</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="capacity"><font size="3">Capacity</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="basePrice"><font size="3">BasePrice</font></label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-7 control-label" for="costPerKm"><font size="3">CostPerKm</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-7 control-label" for="penality"><font size="3">Penality Per Day</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-7 control-label" for="image"><font size="3">Image Name</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-7 control-label" for="location"><font size="3">Location Of Car</font></label>  
  <div class="col-md-4">
  <input id="location" name="location" type="text" placeholder="Enter location of car" class="form-control input-md" required="">
  </div>
</div>
<!-- Button -->
<div class="form-group">
