...
<div class="form-group">
  <label class="col-md-4 control-label" for="costPerKm"><font size="3">LicenseNumber</font></label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="image" name="image" type="text" value="${car.image}" class="form-control input-md" required="">
    
  </div>
</div>
<div class="form-group">
  <label class="col-md-4 control-label" for="location"><font size="3">Location Of Car</font></label>  
  <div class="col-md-4">
  <input id="location" name="location" type="text" value="${car.location}" class="form-control input-md" required="">
  </div>
</div>
<!-- Button -->
<div class="form-group">
